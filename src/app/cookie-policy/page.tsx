          ...
          <div className="prose prose-gray mx-auto max-w-3xl dark:prose-invert">
            <div className="space-y-8">
              ...
              <div>
                ...
                <p className="mt-4 text-muted-foreground leading-relaxed">
                  ChatFlow AI uses cookies and similar technologies for several purposes:
                </p>
              ...
              <div>
                ...
                <p className="mt-4 text-muted-foreground leading-relaxed">
                  When you first visit our website, you will be shown a cookie banner asking for
                  your consent to set non-essential cookies. You can change your cookie preferences
              ...
              <div>
                ...
                <p className="mt-4 text-muted-foreground leading-relaxed">
                  ...
                  technology, regulation, or our business practices. Any changes will be posted on
              ...
              <div>
                ...
                <ul className="mt-4 list-disc space-y-2 pl-6 text-muted-foreground">
                  <li>Email: privacy@chatflowai.com</li>
                  <li>
                    Contact form:{" "}
