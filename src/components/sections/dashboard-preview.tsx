...
const analytics = [
  { label: "Total Conversations", value: "12,847", change: "+12.5%", trend: "up" },
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-lg text-muted-foreground">
            A clean, intuitive interface to manage all your chatbots, monitor conversations, and analyze performance.
          </p>
        </div>
            ...
            <div className="flex h-[700px]">
              ...
              <div className="hidden w-64 flex-col border-r border-border bg-sidebar lg:flex">
                ...
                <div className="flex h-16 items-center gap-2 border-b border-sidebar-border px-4">
                  ...
                  <span className="font-semibold text-sidebar-foreground">ChatFlow AI</span>
                </div>
              ...
              <div className="flex flex-1 flex-col overflow-hidden">
                ...
                <div className="flex h-16 items-center justify-between border-b border-border px-6">
                  <div className="flex items-center gap-4">
                    <h1 className="text-lg font-semibold text-foreground">Chatbots</h1>
                ...
                <div className="flex-1 overflow-y-auto p-6">
                  ...
                  <div className="mb-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    {analytics.map((stat) => (
                      <Card key={stat.label} className="border-border bg-muted/50">
                  ...
                  <Card className="border-border bg-muted/30">
                    <CardHeader className="border-b border-border pb-4">
                      <div className="flex items-center justify-between">
                        <CardTitle className="text-lg text-foreground">Your Chatbots</CardTitle>
                        <div className="flex gap-2">
                          <Badge variant="outline" className="cursor-pointer text-muted-foreground hover:text-foreground">
                            All
                          </Badge>
                          <Badge variant="outline" className="cursor-pointer text-muted-foreground hover:text-foreground">
                            Active
                          ...
                          >
                            ...
                            <div className="min-w-0 flex-1">
                              <div className="flex items-center gap-2">
                                ...
                                <Badge 
                                  variant="outline" 
                                  className={bot.status === 'active' ? 'border-green-500/30 bg-green-500/10 text-green-400' : 'border-yellow-500/30 bg-yellow-500/10 text-yellow-400'}
                                >
                                  {bot.status}
                                </Badge>
                              </div>
                            ...
                            <div className="hidden text-right sm:block">
                              ...
                              <div className={`flex items-center justify-end gap-1 text-xs ${
                                bot.trend === 'up' ? 'text-green-400' : 'text-muted-foreground'
                              }`}>
                                {bot.satisfaction > 0 && (
                                  <>
                                    {bot.trend === 'up' && <TrendingUp className="h-3 w-3" />}
                  ...
                  <div className="mt-6 grid gap-4 sm:grid-cols-3">
                    <Card className="group cursor-pointer border-border bg-muted/30 transition-colors hover:border-primary/50">
                      <CardContent className="flex items-center gap-4 p-4">
                        ...
                        <div>
                          <p className="font-medium text-foreground">Flow Builder</p>
                          <p className="text-sm text-muted-foreground">Design conversation flows</p>
                        </div>
                      </CardContent>
                    </Card>
                    <Card className="group cursor-pointer border-border bg-muted/30 transition-colors hover:border-primary/50">
                      <CardContent className="flex items-center gap-4 p-4">
                        ...
                        <div>
                          <p className="font-medium text-foreground">Train AI</p>
                    ...
                    <Card className="group cursor-pointer border-border bg-muted/30 transition-colors hover:border-primary/50">
                      <CardContent className="flex items-center gap-4 p-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">Connect channels</p>
                        </div>
                      </CardContent>
                    </Card>
                  </div>
        ...
        <div className="mt-20 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          {[
            {
              title: "Clean & Minimal",
              description: "Focus on essential information with a clutter-free interface"
            },
            {
            ...
            },
            {
              ...
              description: "Logical structure that makes finding features effortless"
            },
            {
