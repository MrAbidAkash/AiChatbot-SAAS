...
import { FaEnvelope, FaMapMarkerAlt, FaClock, FaPaperPlane, FaBuilding, FaCertificate } from 'react-icons/fa';
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Partnerships & enterprise</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <FaEnvelope className="text-gray-400 mt-1" />
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Data protection & compliance</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-600">
                    Setup takes less than 5 minutes. Simply connect your Facebook page, 
                    customize your AI responses, and you&apos;re ready to automate.
                  </p>
                </div>
                <div>
                  <h3 className="font-semibold text-gray-900 mb-2">
                  ...
                  <p className="text-gray-600">
                    Yes! We offer 24/7 automated support and human support during business hours. 
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              ChatTime AI is proud to be a Bangladesh-based technology company serving 
              customers globally with cutting-edge AI automation solutions.
            </p>
