...
const ResizablePrimitivePanelGroup = (ResizablePrimitive as any).PanelGroup;
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const ResizablePrimitivePanel = (ResizablePrimitive as any).Panel;
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const ResizablePrimitivePanelResizeHandle = (ResizablePrimitive as any)
  .PanelResizeHandle;
